...
<nav class="w3-sidebar w3-red w3-collapse w3-top w3-large w3-padding" style="z-index:3;width:300px;font-weight:bold;" id="mySidebar"><br>
  ...
  <div class="w3-container">
    <h3 class="w3-padding-64"><b>Designing<br></b></h3>
  </div>
...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
  ...
  <div class="w3-row-padding">
    <div class="w3-half">
      <img src="show1.jpg" style="width:100%" onclick="onClick(this)" alt="Concrete meets bricks">
      <img src="show2.jpg" style="width:100%" onclick="onClick(this)" alt="Light, white and tight scandinavian design">
      <img src="show3.jpg" style="width:100%" onclick="onClick(this)" alt="White walls with designer chairs">
    </div>

    <div class="w3-half">
      <img src="show4.jpg" style="width:100%" onclick="onClick(this)" alt="Windows for the atrium">
      <img src="show5.jpg" style="width:100%" onclick="onClick(this)" alt="Bedroom and office in one space">
      <img src="show6.jpg" style="width:100%" onclick="onClick(this)" alt="Scandinavian design">
    </div>
  </div>
  ...
  <div class="w3-row-padding w3-grayscale">
    <div class="w3-col m4 w3-margin-bottom">
      <div class="w3-light-grey">
        <img src="behzad.jpeg" alt="John" style="width:100%">
        <div class="w3-container">
          <h3>Behzad Arif</h3>
    ...
    <div class="w3-col m4 w3-margin-bottom">
      <div class="w3-light-grey">
        <img src="saood2.jpeg" alt="Jane" style="width:100%">
        <div class="w3-container">
          <h3>Ubaida Saood</h3>
          <p class="w3-opacity">Python and Web Developer</p>
          <p>Phasellus eget enim eu lectus faucibus vestibulum. Suspendisse sodales pellentesque elementum.</p>
        </div>
      </div>
    </div>
    <div class="w3-col m4 w3-margin-bottom">
      <div class="w3-light-grey">
        <img src="adnan.jpeg" alt="Mike" style="width:100%">
        <div class="w3-container">
          <h3>Adnan Saquib</h3>
